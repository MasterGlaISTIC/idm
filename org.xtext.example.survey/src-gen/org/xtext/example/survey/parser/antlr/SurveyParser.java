...
public class SurveyParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.xtext.example.survey.parser.antlr.internal.InternalSurveyParser createParser(XtextTokenStream stream) {
		return new org.xtext.example.survey.parser.antlr.internal.InternalSurveyParser(stream, getGrammarAccess());
	}
