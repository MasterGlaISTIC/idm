 ...
 * <ul>
 *   <li>{@link org.xtext.example.survey.survey.impl.QuestionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.survey.survey.impl.QuestionImpl#getOptions <em>Options</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QuestionImpl extends MinimalEObjectImpl.Container implements Question
{
  ...
  public EList<option> getOptions()
  {
    if (options == null)
    {
      options = new EObjectContainmentEList<option>(option.class, this, SurveyPackage.QUESTION__OPTIONS);
    }
    return options;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SurveyPackage.QUESTION__OPTIONS:
