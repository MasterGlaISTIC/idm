 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.PollImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PollImpl extends MinimalEObjectImpl.Container implements Poll
{
  ...
  {
    return MyDslPackage.Literals.POLL;
  }
  ...
  public EList<Question> getQuestions()
  {
    if (questions == null)
    {
      questions = new EObjectContainmentEList<Question>(Question.class, this, MyDslPackage.POLL__QUESTIONS);
    }
    return questions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.POLL__QUESTIONS:
