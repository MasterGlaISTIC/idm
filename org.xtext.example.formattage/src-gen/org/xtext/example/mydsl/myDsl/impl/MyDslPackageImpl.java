...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  public EReference getMyDsl_Polls()
  {
   ...
   * @generated
   */
  public EAttribute getQuestion_Types()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(myDslEClass, MY_DSL__POLLS);

    pollEClass = createEClass(POLL);
    createEReference(pollEClass, POLL__QUESTIONS);

    questionEClass = createEClass(QUESTION);
    createEAttribute(questionEClass, QUESTION__TYPES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getMyDsl_Polls(), this.getPoll(), null, "polls", null, 0, -1, MyDsl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getQuestion_Types(), this.getType(), "types", null, 0, -1, Question.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    // Initialize enums and add enum literals
    initEEnum(typeEEnum, Type.class, "Type");
    addEEnumLiteral(typeEEnum, Type.CHECKBOX);
    addEEnumLiteral(typeEEnum, Type.TEXTBOX);
