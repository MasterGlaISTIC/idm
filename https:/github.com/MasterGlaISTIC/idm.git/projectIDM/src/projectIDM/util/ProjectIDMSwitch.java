 ...
 * @generated
 */
public class ProjectIDMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProjectIDMPackage.POLL_SYSTEM: {
				PollSystem pollSystem = (PollSystem)theEObject;
				T result = casePollSystem(pollSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectIDMPackage.POLL: {
				Poll poll = (Poll)theEObject;
				T result = casePoll(poll);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectIDMPackage.QUESTION: {
				Question question = (Question)theEObject;
				T result = caseQuestion(question);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectIDMPackage.NAME: {
				Name name = (Name)theEObject;
				T result = caseName(name);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectIDMPackage.OPTION: {
				Option option = (Option)theEObject;
				T result = caseOption(option);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectIDMPackage.TEXT_BOX: {
				TextBox textBox = (TextBox)theEObject;
				T result = caseTextBox(textBox);
				if (result == null) result = caseOption(textBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectIDMPackage.CHECK_BOX: {
				CheckBox checkBox = (CheckBox)theEObject;
				T result = caseCheckBox(checkBox);
				if (result == null) result = caseOption(checkBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
